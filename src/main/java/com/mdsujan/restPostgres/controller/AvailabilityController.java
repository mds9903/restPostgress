...
public class AvailabilityController {
    ...
    @GetMapping("/v1/availability/{itemId}/{locationId}") // get availability qty of item at a given location
    public AvailabilityV1Response getAvlQtyByItemAndLocationV1(@PathVariable Long itemId, @PathVariable Long locationId) throws Throwable {
